"""byte3 final: control case b3=1 (the app's hardcoded value) + 0/2/3/4.
Theory: only 1 draws; 2 nacks; 0/3/4 silently swallowed."""
...
CASES = [
    (1, (255, 255, 255), (3, 8), "WHITE  b3=1 left (CONTROL -- must appear)"),
    (0, (255, 0, 0), (9, 8), "RED    b3=0"),
    (2, (0, 255, 0), (15, 8), "GREEN  b3=2"),
    (3, (0, 128, 255), (21, 8), "BLUE   b3=3"),
    (4, (255, 220, 0), (27, 8), "YELLOW b3=4"),
]
...
async def main() -> None:
    ...
    async with IDotMatrixClient.connect_to(ADDRESS, ScreenSize.SIZE_32x32) as client:
        ...
        print("<< which of the five blocks exist: white? red? green? blue? yellow? (12s)", flush=True)
