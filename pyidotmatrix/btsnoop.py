...
Usage (installed console script; `python -m pyidotmatrix.btsnoop` and the
tools/parse_btsnoop.py shim take the same arguments):

    pyidotmatrix-btsnoop capture.log
    pyidotmatrix-btsnoop capture.log --stats
    pyidotmatrix-btsnoop capture.log --only writes --grep "05 00 03 01"
    pyidotmatrix-btsnoop capture.log --json > events.json
"""
