...
_ENTRIES: tuple[Capability, ...] = (
    ...
    Capability(
        ...
        "prior-reconnect rescue is a REAL, SEPARATE effect and ITS MECHANISM IS OPEN. "
        "RETRACTED 2026-07-28: a claim that a prior reconnect ARMS THE FLASH COMMIT (P19 G8) "
        "does NOT hold. It rested on a matched pair at an 8 s hold -- armed committed, unarmed "
        "did not -- and P19 G9 (probes/probe_p19_g9_commit_ladder.py) then re-ran 8 s UNARMED "
        "and it DID commit. 8 s commits inconsistently, so the pair is not a contrast. ROOT "
